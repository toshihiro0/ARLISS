...
int PPMMODE_STABILIZE_NOSEUP[8] = {500,900,0,500,525,500,500,0}; //900側が機首上げ
int PPMMODE_STABILIZE[8] = {500,500,300,500,525,500,500,0}; //300から徐々に上げる
int PPMMODE_AUTO[8] = {500,500,0,500,815,500,500,0};
int PPMMODE_DEEPSTALL[8] = {500,900,0,500,525,500,500,0}; //900側がエレベーター上げ
